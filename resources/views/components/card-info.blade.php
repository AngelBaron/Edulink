...
<div class="w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
        ...
        <button  data-id="{{ $dataid }}" onclick="setDeleteRoute('{{ $dataid }}','{{route('materias.destroy', ['id' => '__id__']) }}')"  data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="w-full sm:w-auto bg-red-950 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-red-800 dark:hover:bg-red-700 dark:focus:ring-red-800">
            <div class="text-left rtl:text-right ">
